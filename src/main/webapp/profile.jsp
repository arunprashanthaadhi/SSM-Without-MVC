				...
				<div class="form-container">
					<form action="ProfileServlet" method="Get">
						...
						<input
							...
							name="lastname" value="${lastname}"readonly="readonly">
							
							 <label
							for="dob">D.O.B:</label> 
							<input type="date" id="dob"
							name="dob" value="${dob}" readonly="readonly"> 
							...
							name="address" value="${address}" readonly="readonly"> 
							
							<label
							for="about">About:</label> 
							<input type="text"
							id="about" name="about"value="${about}"  readonly="readonly">
