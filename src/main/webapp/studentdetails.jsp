...
<table>
        ...
        <c:forEach var="student" items="${studentList}">
            <tr>
                ...
                <td><a href='EditStudentServlet?userid=${student.userId}' style='color: green; text-decoration: none;'>Edit</a> | <a href='DeleteStudentServlet?userid=${student.userId}' onclick="return confirmDelete();" style='color: Red; text-decoration: none;'>Delete</a> </td>
            </tr>
       </c:forEach>	
                </table>
            </div>
